<template>
  <div class="sm:ml-64 ">
    <div class="flex flex-col justify-center items-center  sm:p-4">
      <form @submit.prevent="handleAddParents" class="md:w-[50%] sm:w-full  p-6 shadow-xl">
...
async function handleAddParents(){
  if(
  ...
  await axios.post("/api/parents/store" , parentBody).then((response)=>{
