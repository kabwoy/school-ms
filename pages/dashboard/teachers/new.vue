<template>
  ...
  <div class="sm:ml-64 ">
    <div class="flex flex-col justify-center items-center  sm:p-4">
      <form @submit.prevent="handleAddTeacher" class="md:w-[50%] sm:w-full  p-6 shadow-xl">
        ...
        <div class="bg-gray-200 px-4 py-3 rounded-xl">
          ...
          <div class="mb-4">
            <input class="w-full py-4 rounded" required autocomplete="" type="email" v-model="email" placeholder="email">
          </div>
          <div class="mb-4">
...
async function handleAddTeacher(){
  ...
  axios.post("/api/teachers/store" , teacherBody).then((response)=>{
    f_name.value = ""
    l_name.value = ""
    gender.value = ""
    id_number.value = ""
